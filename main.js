...
class StartScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(200, 150, "Run A Marathon With A Dino", { fontSize: '28px', fill: '#fff', fontFamily: "SilkScreen", backgroundColor: 'rgba(0,0,0,0.7)' });
        this.add.text(200, 200, "Select your starting item", { fontSize: '20px', fill: '#fff', fontFamily: "SilkScreen", backgroundColor: 'rgba(0,0,0,0.7)' });
